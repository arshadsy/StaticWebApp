                ...
                <div className="card card-body" style={{overflowWrap:'anywhere'}}>
                    <table>
                        <tbody className="align-top">
                            <tr >
                                {/* //phone */}
                                <td><svg height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <tr>
                                {/* //github */}
                                <td><svg height="24" width="24" aria-hidden="true" viewBox="0 0 24 24" version="1.1" data-view-component="true" class="octicon octicon-mark-github v-align-middle">
                            ...
                            <tr>
                                {/* //linkedin */}
                                <td><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 27 27" focusable="false" class="lazy-loaded" aria-busy="false">
                                <g fill="currentColor">
