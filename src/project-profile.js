export function ProjectProfile() {
  return (
    <div className="p-0">
      <ul id="project-profile" className="list-group">
              ...
              <td>
                ...
                <ul className="list-group">
                  <li className="list-group-item">
                    As a senior developer, I am tasked with resolving production
                    issues and ensure data integrity.
                  </li>
                  <li className="list-group-item">
                    I am also responsible to analyze the existing code and
                    optimize the structure to help improve performance and code
                    reusability as well as maintainability.
                  </li>
                  <li className="list-group-item">
                    Provide daily updates regarding the progress to my lead and
                    Managers.
                  </li>
                  <li className="list-group-item">
        ...
        <li className="list-group-item card">
          ...
          <table className="table card-body app-table-row-border">
            ...
            <tr>
              <th>Technologies Involved</th>
              <td>
                dotnet Core, MVC, WebAPI, ReactJS. MongoDB, Sql Server, Docker,
                Kubernetis
              </td>
            </tr>
            <tr>
              <th>Description</th>
              <td>
                Integration Project is a proof of concept project developed for
                in-house usability, the objective is to provide the whole of
                Accenture internal projects with a centralized and robust system
                to perform routine tasks from one location
              </td>
            </tr>
            <tr>
              <th>Responsibility</th>
        ...
        <li className="list-group-item card">
          ...
          <table className="table card-body app-table-row-border">
            ...
            <tr>
              <th>Technologies Involved</th>
              <td>PL/SQL, Oracle Web Forms(web package), ASP.NET MVC5 (C#)</td>
            </tr>
            <tr>
              <th>Description</th>
              <td>
                This project is about providing Technical and Functional
                solution to client regarding enhancements and applying fixes to
                the Application by working with various teams like Design,
              ...
              <td>
                ...
                <ul className="list-group">
                  <li className="list-group-item">
                    ...
                    assigned to me transition through each stage of Development
                    in a seamless manner and I am also responsible to monitor
                    and facilitate other teams to test and deploy changes into
                ...
                <ul className="list-group">
                  <li className="list-group-item">
                    ...
                    fixing minor data related ussies in Production Environment.
                  </li>
                  <li className="list-group-item">
                    In case standard procedure does not exist, analyze the task,
                    document it and proceed to fix post approval of proposed
                    standard work.
                  </li>
                </ul>
              </td>
          ...
          <table className="table card-body app-table-row-border">
            ...
            <tr>
              <th>Responsibility</th>
              <td>
                Support and Maintainance L1:SQL Server
                <br />
                <ul className="list-group">
                  <li className="list-group-item">
                  ...
                  <li className="list-group-item">
                    Monitor tasks and provide daily updates to clients regarding
                    task status, failures, and fixes applied.
                  </li>
                </ul>
                Minor Standard Tasks:
                <ul className="list-group">
