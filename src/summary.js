export function Summary() {
  return (
    <div className="p-0">
      <ul id="summary" className="list-group">
        ...
        <li className="list-group-item">
          Experienced in Test Driven Development(TDD), Data Driven Development,
          Paired Programming.
        </li>
        <li className="list-group-item">
          Experience in Kubernetis deployment.
        </li>
        <li className="list-group-item">
        ...
        <li className="list-group-item">
          Understanding of Conventional and Attribute Based routing techniques.
        </li>
        <li className="list-group-item">
        ...
        <li className="list-group-item">
          Worked with Oracle collections objects and performance improvement of
          Oracle PLSQL.
        </li>
      </ul>
    </div>
